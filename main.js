...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/816VUKdPV/model.json",modelLoaded);
...
function gotResult(error, results){
    if (error){
        ...
        if(results[0].label == "com"){
            document.getElementById("update_emoji").innerHTML = "&#x1F637;";
        }
        if(results[0].label == "sem"){
            document.getElementById("update_emoji").innerHTML = "&#x26d4;";
        }
    }
}